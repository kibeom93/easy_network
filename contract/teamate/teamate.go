...
func (s *SmartContarct) Init(APIstub shim.Chaincode) sc.Response{
	return shim.Success(nil)
}
func (s *SmartContarct) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
...
func (s *SmartContarct) addUser(APIstub shim.ChaincodeStubInterface, args [] string) sc.Response {
...
func (s *SmartContarct) addRating(APIstub shim.ChaincodeStubInterface, args []string) sc.Response{
	if len(args) !=3 {
...
func (s *SmartContarct) readRating(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func main() {
	...
	err := shim.Start(new(SmartContarct))
	if err != nil {
